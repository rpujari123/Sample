...
public class Configuration_Test extends BaseTest {
	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.Configuration_Test_XLS);
		testName = "Configuration_Prod_Test";
