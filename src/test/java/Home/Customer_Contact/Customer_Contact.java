...
public class Customer_Contact extends BaseTest {
	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.Customer_Contact_XLS);
		testName = "Customer_Contact_Test";
