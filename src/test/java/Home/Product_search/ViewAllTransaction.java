...
public class ViewAllTransaction extends BaseTest {
	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.ViewAllTransaction_XLS);
		testName = "ViewAllTransaction_Test";
