...
public class Opportunity_Report extends BaseTest {
	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.OpportunityReport_XLS);
		testName = "OpportunityReport_Test";
