...
public class Notification_Rules extends BaseTest{
	
	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.Notification_Rules_XLS);
		testName = "Notification_Rules_test";
	}
