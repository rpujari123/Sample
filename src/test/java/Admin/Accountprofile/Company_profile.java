...
public class Company_profile extends BaseTest{

	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.Company_profile_XLS);
		testName = "Company_profile_Test";
	}
