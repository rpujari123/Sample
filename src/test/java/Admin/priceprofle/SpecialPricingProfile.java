...
public class SpecialPricingProfile extends BaseTest{

	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.SpecialPricingProfile_XLS);
		testName = "SpecialPricingProfile_Test";
	}
