...
public class Opportunity_Dashboard extends BaseTest {
	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.Opportunity_Dashboard_XLS);
		testName = "Opportunity_Dashboard_Test";
	}
