package Ecommerce.Rstorecustomization;
...
public class RstoreCustomization extends BaseTest {


	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.RStore_Customization_XLS);
		testName = "RStore_Customization";
	}
