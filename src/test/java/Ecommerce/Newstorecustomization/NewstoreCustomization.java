package Ecommerce.Newstorecustomization;
...
public class NewstoreCustomization extends BaseTest{
	
	@BeforeTest
	public void init(){
		
		xls = new Xls_Reader(Constants.NewStore_customization_XLS);
		testName = "NewStore_customization";
	}
